import yamlTransform from '../src/yamlTransformation'
...
describe('yamlTest', () => {
  test('include and exclude test', async () => {
    const options: PluginOptions = {
      yaml: {
        enabled: true,
        include: /testInclude.yaml/,
        exclude: /testExclude.yaml/,
      },
    }

    let transformResult = yamlTransform(options, '', 'testExclude.yaml')
    expect(transformResult).toBeNull()

    transformResult = yamlTransform(options, '', 'testFile.yaml')
    expect(transformResult).toBeNull()

    transformResult = yamlTransform(options, '', 'testInclude.yaml')
    expect(transformResult).not.toBeNull()
  })

  test('yaml transform', async () => {
    const path: string = join(__dirname, './files/vue.yaml')
    const yamlContent: string = fs.readFileSync(path).toString()
    const options: PluginOptions = { yaml: { enabled: true } }
    const transformResult = yamlTransform(options, yamlContent, '')
    expect(transformResult.code).toEqual(`var data = { name:"Vue",
  scopeName:"source.vue",
  fileTypes:[ "vue" ],
  uuid:"5512c10d-4cc5-434c-b8fc-53b912f55ab3",
  patterns:[ { name:"comment.block.html",
      test:"testabcd",
      begin:"<!--",
      end:"-->",
      captures:{ 0:{ name:"punctuation.definition.comment.html" } } },
    { begin:"(<)(?=template.*[^/>]*/>\\\\s*$)",
      beginCaptures:{ 1:{ name:"punctuation.definition.tag.begin.html" } },
      end:"(/>)",
      endCaptures:{ 1:{ name:"punctuation.definition.tag.end.html" } },
      patterns:[ { begin:"(template)",
          beginCaptures:{ 1:{ name:"entity.name.tag.template.html" } },
          end:"(?=/>)",
    ...
    { begin:"(<)(template)(?=[^>]*>[^/>]*</template>)",
      ...
      endCaptures:{ 1:{ name:"punctuation.definition.tag.begin.html" },
        2:{ name:"entity.name.tag.template.html" },
    ...
    { begin:"(<)(template)\\\\b(?=[^>]*lang=('slm'|\\"slm\\"))(?![^/>]*/>\\\\s*$)",
      ...
      patterns:[ { include:"#tag-stuff" },
        { contentName:"text.jade.slm",
          ...
          patterns:[ { include:"text.jade.slm" } ] } ] },
    { begin:"(<)(template)\\\\b(?=[^>]*lang=('liquid'|\\"liquid\\"))(?![^/>]*/>\\\\s*$)",
      ...
      patterns:[ { include:"#tag-stuff" },
        { contentName:"text.html.liquid",
          ...
          patterns:[ { include:"text.html.liquid" } ] } ] },
    { begin:"(<)(template)(?![^/>]*/>\\\\s*$)",
      beginCaptures:{ 1:{ name:"punctuation.definition.tag.begin.html" },
        2:{ name:"entity.name.tag.template.html" } },
      end:"^(</)(template)(>)",
      ...
      patterns:[ { include:"#tag-stuff" },
        { contentName:"text.html.vue-html",
          ...
          patterns:[ { include:"text.html.vue-html" } ] } ] },
    { begin:"(<)(style)\\\\b(?=[^/>]*/>\\\\s*$)",
      beginCaptures:{ 1:{ name:"punctuation.definition.tag.begin.html" },
    ...
    { begin:"(<)(style)\\\\b(?=[^>]*lang=(['\\"]sss['\\"]))(?![^/>]*/>\\\\s*$)",
      ...
      patterns:[ { include:"#tag-stuff" },
        { contentName:"source.css.sugarss",
          ...
          patterns:[ { include:"source.css.sugarss" } ] } ] },
    { begin:"(<)(style)(?![^/>]*/>\\\\s*$)",
      beginCaptures:{ 1:{ name:"punctuation.definition.tag.begin.html" },
        2:{ name:"entity.name.tag.style.html" } },
      end:"(</)(style)(>)",
  ...
  repository:{ entities:{ patterns:[ { name:"constant.character.entity.html",
          match:"(&)([a-zA-Z0-9]+|#[0-9]+|#x[0-9a-fA-F]+)(;)",
          captures:{ 1:{ name:"punctuation.definition.entity.html" },
            3:{ name:"punctuation.definition.entity.html" } } },
        { name:"invalid.illegal.bad-ampersand.html",
          match:"&" } ] },
    "string-double-quoted":{ name:"string.quoted.double.html",
      begin:"\\"",
      beginCaptures:{ 0:{ name:"punctuation.definition.string.begin.html" } },
      end:"\\"",
      endCaptures:{ 0:{ name:"punctuation.definition.string.end.html" } },
      patterns:[ { include:"#vue-interpolations" },
        { include:"#entities" } ] },
    "string-single-quoted":{ name:"string.quoted.single.html",
      begin:"'",
      beginCaptures:{ 0:{ name:"punctuation.definition.string.begin.html" } },
      end:"'",
      endCaptures:{ 0:{ name:"punctuation.definition.string.end.html" } },
      patterns:[ { include:"#vue-interpolations" },
        { include:"#entities" } ] },
    "tag-generic-attribute":{ name:"entity.other.attribute-name.html",
      match:"\\\\b([a-zA-Z\\\\-:_]+)" },
    "tag-id-attribute":{ name:"meta.attribute-with-value.id.html",
      begin:"\\\\b(id)\\\\b\\\\s*(=)",
      end:"(?<='|\\")",
      captures:{ 1:{ name:"entity.other.attribute-name.id.html" },
        2:{ name:"punctuation.separator.key-value.html" } },
      patterns:[ { name:"string.quoted.double.html",
        ...
        { name:"string.quoted.single.html",
          ...
          patterns:[ { include:"#vue-interpolations" },
            { include:"#entities" } ] } ] },
    "tag-stuff":{ patterns:[ { include:"#vue-directives" },
        { include:"#tag-id-attribute" },
        { include:"#tag-generic-attribute" },
        { include:"#string-double-quoted" },
        { include:"#string-single-quoted" } ] },
    "vue-directives":{ name:"meta.directive.vue",
      ...
      patterns:[ { name:"source.directive.vue",
          begin:"\`",
          beginCaptures:{ 0:{ name:"punctuation.definition.string.begin.html" } },
          end:"\`",
          endCaptures:{ 0:{ name:"punctuation.definition.string.end.html" } },
        ...
        { name:"source.directive.vue",
          ...
          endCaptures:{ 0:{ name:"punctuation.definition.string.end.html" } },
          patterns:[ { include:"source.js#expression" } ] } ] },
    "vue-interpolations":{ patterns:[ { name:"expression.embedded.vue",
          begin:"\\\\{\\\\{\\\\{?",
